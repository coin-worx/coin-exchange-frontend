    ...
    <div class="frame" style="width: 950px;">
      ...
      <div id="DataTables_Table_5_wrapper" class="dataTables_wrapper form-inline" role="grid"><div
          ...
          <tr role="row"><th class="lalign nw sorting" role="columnheader" tabindex="0"
                             aria-controls="DataTables_Table_5" rowspan="1" colspan="1"
                             aria-label="Ledger ID: activate to sort column ascending"
                             style="width: 85px;">Ledger ID</th><th class="lalign sorting_desc" role="columnheader"
                                                                    tabindex="0" aria-controls="DataTables_Table_5"
                                                                    rowspan="1" colspan="1" aria-sort="descending"
                                                                    aria-label="Date: activate to sort column ascending">Date</th><th
              class="lalign sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_5" rowspan="1"
              colspan="1" aria-label="Type: activate to sort column ascending">Type</th><th class="lalign sorting"
                                                                                            role="columnheader"
                                                                                            tabindex="0"
              ...
              colspan="1" aria-label="Amount: activate to sort column ascending">Amount</th><th
              class="ralign sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_5" rowspan="1"
              colspan="1" aria-label="Fee: activate to sort column ascending">Fee</th><th class="ralign sorting"
                                                                                          role="columnheader"
                                                                                          tabindex="0"
                                                                                          aria-controls="DataTables_Table_5"
                                                                                          rowspan="1" colspan="1"
                                                                                          aria-label="Balance: activate to sort column ascending">Balance</th>
          </tr>
          </thead>
          ...
          <tbody role="alert" aria-live="polite" aria-relevant="all"><tr id="LKJCDF-DOFW7-LZH2FO" class="odd"><td
              ...
              class="ralign neg"><div class="textAlignDecimal"><span>-Ʀ552</span><span
                style="width: 7px;">.</span><span style="width: 35px;">12000</span></div></td><td
              class="ralign"><div class="textAlignDecimal"><span>Ʀ0</span><span style="width: 7px;">.</span><span
              ...
              class="ralign neg"><div class="textAlignDecimal"><span>-฿0</span><span
                style="width: 7px;">.</span><span style="width: 35px;">01000</span></div></td><td
              class="ralign"><div class="textAlignDecimal"><span>฿0</span><span style="width: 7px;">.</span><span
                style="width: 35px;">00000</span></div></td><td class="ralign"><div
              class="textAlignDecimal"><span>฿0</span><span style="width: 7px;">.</span><span
              ...
              class="ralign neg"><div class="textAlignDecimal"><span>-Ʀ99</span><span
                style="width: 7px;">.</span><span style="width: 35px;">99998</span></div></td><td
              class="ralign"><div class="textAlignDecimal"><span>Ʀ0</span><span style="width: 7px;">.</span><span
              ...
              class="ralign neg"><div class="textAlignDecimal"><span>-฿0</span><span
                style="width: 7px;">.</span><span style="width: 35px;">00050</span></div></td><td
              class="ralign"><div class="textAlignDecimal"><span>฿0</span><span style="width: 7px;">.</span><span
              ...
              class="ralign neg"><div class="textAlignDecimal"><span>-Ł8</span><span
                style="width: 7px;">.</span><span style="width: 35px;">32500</span></div></td><td
              class="ralign"><div class="textAlignDecimal"><span>Ł0</span><span style="width: 7px;">.</span><span
        ...
        <div><div class="pull-left"><div class="dataTables_info"
                                         id="DataTables_Table_5_info">1 - 10 of 13 ledger entries</div></div>
