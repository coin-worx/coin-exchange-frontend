...
<div class="frame" style="width: 950px;">
  ...
  <div class="vmarg40bot">
    <div id="DataTables_Table_6_wrapper" class="dataTables_wrapper form-inline" role="grid"><div
        class="dataTables_table_wrapper"><table
          ...
          id="DataTables_Table_6" aria-describedby="DataTables_Table_6_info">
        <thead>
        <tr role="row"><th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1"
                           style="width: 25px;" aria-label=""></th><th class="lalign nw sorting" role="columnheader"
                                                                       tabindex="0" aria-controls="DataTables_Table_6"
                                                                       rowspan="1" colspan="1" style="width: 55px;"
                                                                       aria-label="Order: activate to sort column ascending">Order</th><th
            class="lalign sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_6" rowspan="1"
            colspan="1" aria-label="Order Type: activate to sort column ascending">Order Type</th><th
            class="lalign sorting_desc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_6" rowspan="1"
            ...
            aria-label="Pair: activate to sort column ascending">Pair</th><th class="ralign nw sorting"
                                                                              ...
                                                                              aria-controls="DataTables_Table_6"
                                                                              rowspan="1" colspan="1"
                                                                              style="width: 80px;"
                                                                              aria-label="Avg. Price: activate to sort column ascending">Avg. Price</th><th
            class="ralign nw sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_6" rowspan="1"
      ...
      <div><div class="pull-left"><div class="dataTables_info" id="DataTables_Table_6_info"></div></div>
  ...
  <h4 class="title">Closed Positions</h4>

  <div id="DataTables_Table_8_wrapper" class="dataTables_wrapper form-inline" role="grid"><div
      class="dataTables_table_wrapper"><table
        class="table table-hover table-striped table-trades table-position-hist dataTable table-drilldown"
        id="DataTables_Table_8" aria-describedby="DataTables_Table_8_info">
      <thead>
      <tr role="row"><th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1"
                         style="width: 25px;" aria-label=""></th><th class="lalign nw sorting" role="columnheader"
                                                                     tabindex="0" aria-controls="DataTables_Table_8"
                                                                     rowspan="1" colspan="1" style="width: 55px;"
                                                                     aria-label="Order: activate to sort column ascending">Order</th><th
          class="lalign sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_8" rowspan="1"
          colspan="1" aria-label="Order Type: activate to sort column ascending">Order Type</th><th
          class="lalign sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_8" rowspan="1"
          colspan="1" style="width: 60px;" aria-label="Pair: activate to sort column ascending">Pair</th><th
          class="ralign nw sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_8" rowspan="1"
          colspan="1" aria-label="Avg. Price: activate to sort column ascending">Avg. Price</th><th
          class="ralign nw sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_8" rowspan="1"
          colspan="1" style="width: 80px;"
          aria-label="Closing Cost: activate to sort column ascending">Closing Cost</th><th class="ralign nw sorting"
                                                                                            role="columnheader"
                                                                                            tabindex="0"
                                                                                            ...
                                                                                            aria-label="P/L: activate to sort column ascending">P/L</th><th
          class="ralign nw sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_8" rowspan="1"
          colspan="1" style="width: 60px;" aria-label="P/L (%): activate to sort column ascending">P/L (%)</th><th
          class="ralign sorting_desc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_8" rowspan="1"
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd"><td valign="top" colspan="9"
                                                                                     class="dataTables_empty">No positions available.</td>
      </tr></tbody></table></div>

    <div><div class="pull-left"><div class="dataTables_info" id="DataTables_Table_8_info"></div></div>
...
<div class="position-data-wrap vpad20top">
  <ul class="nav nav-tabs spaced10" id="position-grouped-data-nav">
    <li class="active"><a href="#position-grouped-data-overview" data-toggle="tab">Overview</a></li>
    <li><a href="#position-grouped-data-trades" data-toggle="tab">Trade Positions</a></li>
    <li><a href="#position-grouped-data-closing" data-toggle="tab">Closing Orders</a></li>
  </ul>

  <div class="tab-content vpad10top">
    <div class="tab-pane active" id="position-grouped-data-overview">
    ...
    <div class="tab-pane" id="position-grouped-data-trades">
    ...
    <div class="tab-pane" id="position-grouped-data-closing">
...
<div class="vmarg10bot">
  ...
  <div class="position-data-wrap vpad20top">
    <div class="clearfix">
      <ul class="nav nav-tabs spaced10" id="position-data-nav">
        <li class="active"><a href="#position-data-overview" data-toggle="tab">Overview</a></li>
        <li><a href="#position-data-opening" data-toggle="tab">Opening Trade</a></li>
        <li><a href="#position-data-closing" data-toggle="tab">Closing Trades</a></li>
      </ul>
    </div>

    <div class="tab-content">
      <div class="tab-pane active" id="position-data-overview">
        <div class="row stats-dots-wrap">
          <div class="span6">
            <div class="hpad20right">
              <table class="stats-dots">
      ...
      <div class="tab-pane" id="position-data-opening">
        <div class="vmarg20bot">
      ...
      <div class="tab-pane" id="position-data-closing">
        <div>
