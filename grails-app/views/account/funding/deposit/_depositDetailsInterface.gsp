...
<div id="deposit-content"%{-- ng-show="showDetails"--}% class="span10" data-locked="0">
    <g:render template="/account/funding/deposit/depositDetails"/>
</div>
