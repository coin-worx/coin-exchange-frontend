...
angular.module('marketData.orderBook').controller('NewAndOpenOrderBookController', [
  '$scope', 'NewAndOpenOrderBookService', function ($scope, newAndOpenOrderBookService) {
    var loaded = false;
